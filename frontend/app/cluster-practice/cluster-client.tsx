...
import BlankConstructedResponse from "@/components/ui/blank-constructed-response"
    ...
    return (
        <div className="flex flex-col w-full md:flex-row mt-5 gap-10">
            ...
            <div className="flex flex-col flex-1 min-h-screen w-full justify-start items-center">
                {chosenCluster["clusterNumber"] !== -1 ? <ClusterDisplay cluster={chosenCluster} recordAnswers={handleSubmittedAnswers} /> : <BlankConstructedResponse/>}
            </div>
